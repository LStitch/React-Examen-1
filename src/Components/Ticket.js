        ...
        <div className="Lista">
        {
           ...
           ?<div>
                ...
                <div className="Compra">
                  ...
                  <p><strong>Cantidad: </strong><input type='number' readOnly="" className="text-left" style={{width: '7vmin'}} value={props.compra.cantidad} min="1" max="6" onChange={e=>props.calcular(e.target.value,props.compra)}/></p>
